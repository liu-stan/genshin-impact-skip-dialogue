...
interact_button = ImageButton('images/interact.jpg',crop_posi= [1079,350 ,1162, 751 ],threshold=0.99, mask=True)
dialogue_button = ImageButton('images/dialogue.jpg', crop_posi=[1140, 320, 1223, 930], threshold=0.99,)
...
play0_button = ImageButton('images/play0.jpg',crop_posi= [45, 26, 99, 77] ,threshold=0.99)
play1_button = ImageButton('images/play1.jpg',crop_posi= [45, 26, 99, 77] ,threshold=0.99)
paim_button = ImageButton('images/paim.jpg',crop_posi= [11, 11, 106, 103] ,threshold=0.99)
task_button = ImageButton('images/task.jpg',crop_posi= [24, 170, 95, 248] ,threshold=0.99,  mask=True)
skip_dialogue_button = ImageButton('images/dialogue.jpg', crop_posi=[1266, 763, 1326, 855],threshold=0.99,)
...
def run_task():
    ...
    if not ui.handle:
        ...
        return
    if ui.capture.shape[:2] != (1080, 1920):
        wait_secs('window resolution is not 1080', 3.0)
        return
    tasklist = [
        pick_up_task,
        skip_dialogue_task,
